...
class Listing(models.Model):
    ...
    class HomeType(models.TextChoices):  # Corrected typo from HomeTyp to HomeType
        HOUSE = 'House'
        CONDO = 'condo'
        TOWNHOUSE = 'Townhouse'
    ...
    bathrooms = models.DecimalField(max_digits=3, decimal_places=1)  # Corrected field type
    ...
    photo_10 = models.ImageField(upload_to='photos/%Y/%m/%d', blank=True)  # Corrected duplicate field name
